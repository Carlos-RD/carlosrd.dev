...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Prague,<br> CZE</td>
        <tr>
            <td><img class="customEntitityLogo" style="background-color:white" src="symantec.png"/></td>
         ...
         <tr>
            <td rowspan=4><img class="customEntitityLogo" style="background-color:white" src="att.png"/></td>
        ...
        <tr>
           ...
           <tr>
            <td><img class="customEntitityLogo" style="background-color:white"src="nostracom.png"/></td>
...
<table>
    ...
    <tbody>
        <tr>
            <td><img class="customEntitityLogo" style="background-color:white"  src="uoy.png"/></td>
        ...
        <tr>
            <td><img class="customEntitityLogo" style="background-color:white"src="uol.png"/></td>
        ...
        <tr>
            <td><img class="customEntitityLogo" style="background-color:white"src="virgen.png"/></td>
